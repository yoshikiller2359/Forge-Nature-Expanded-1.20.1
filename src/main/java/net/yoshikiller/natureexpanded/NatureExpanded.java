package net.yoshikiller.natureexpanded;
...
@Mod(NatureExpanded.MOD_ID)
public class NatureExpanded {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "natureexpanded";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();
    public NatureExpanded() {
